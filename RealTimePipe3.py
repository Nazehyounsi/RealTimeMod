...
import os
from ClientOpenface import Client
...
#  UTILISER LE CODE SERVER ET OPENFACE FRAME ET LA FONCTION SENDPOSITIVITY QUI RECUPERE LES AU VIA OPENFACE, et LA MODIFIER POUR CREE UN SENDER VERS CE CODE PYTHON
